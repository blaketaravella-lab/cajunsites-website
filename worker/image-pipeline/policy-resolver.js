...
export function resolveImagePolicy(prospect){
 const specialized=resolveSpecializedPolicy(prospect),services=serviceNames(prospect),trustedFamily=family(trustedIdentity(prospect)),researchFamily=family(researchIdentity(prospect));
